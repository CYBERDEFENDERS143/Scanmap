...
def dtect():
	print("_________        ___.                 ")
    print("\_   ___ \___.__.\_ |__   ___________")
    print("/    \  \<   |  | | __ \_/ __ \_  __ \ ")
    print("\     \___\___  | | \_\ \  ___/|  | \/")
    print("\______  / ____| |___  /\___  >__|   ")
    print("       \/\/          \/     \/")
    print("")
    print(" ____        __               __")
    print("|  __ \      / _|             | |")
    print("| |  | | ___| |_ ___ _ __   __| |___")
    print("| |  | |/ _ \  _/ _ \ '_ \ / _` |/ __|")
    print("| |__| |  __/ ||  __/ | | | (_| |\__ \ ")
    print("|_____/ \___|_| \___|_| |_|\__,_||___/")
	print("")
	print(" Created by : CYBERDEFENDERS")
	print("")
	def menu():
